...
class RouteService {
  static list = (page: number, size: number) => request(`/apisix_admin/v1/apisix/route/list?page=${page}&size=${size}`, { method: 'GET' })
  static get = (id: string) => request(`/apisix_admin/v1/apisix/route/get?id=${id}`, { method: 'GET' })
